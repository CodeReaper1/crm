...
echo getHeader('Currently Working With', 'customers');
?>
...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
      ...
      <div class="ms-auto">
        <div class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
            ...
            <a class="dropdown-item move-business" href="javascript:;" data-from="currentlyWorkingWith" data-to="callStack">Move to Call Stack</a>
            <a class="dropdown-item move-business" href="javascript:;" data-from="currentlyWorkingWith" data-to="coldLeads">Move to Cold Leads</a>
            <a class="dropdown-item move-business" href="javascript:;" data-from="currentlyWorkingWith" data-to="warmLeads">Move to Warm Leads</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex align-items-center">
      <h6 class="mb-0 text-uppercase">Currently Working With</h6>
      <div class="ms-auto">
        <a href="add-lead.php?category=currentlyWorkingWith" class="btn btn-sm btn-primary">
    ...
    <div class="card">
      <div class="card-body">
        <div class="table-responsive">
          <table id="currentlyWorkingWithTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
              <tr>
                <th>Niche</th>
                <th>Company Name</th>
...
$(document).ready(function() {
    var currentlyWorkingWithTable = $('#currentlyWorkingWithTable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": "fetch_leads.php",
            "type": "POST",
            "data": function(d) {
                d.category = "currentlyWorkingWith"; // Explicitly set the category
                return d;
            }
        },
        "paging": true,
    ...
    $('#currentlyWorkingWithTable tbody').on('click', 'tr', function(e) {
        ...
        var data = currentlyWorkingWithTable.row(this).data();
        if (data) {
    ...
    if (savedLeadId) {
        ...
        currentlyWorkingWithTable.on('draw', function() {
            // Find the row with this ID and select it
            const savedRow = $(`#currentlyWorkingWithTable tbody tr[data-id="${savedLeadId}"]`);
