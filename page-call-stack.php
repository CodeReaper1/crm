...
echo getHeader('Call Stack', 'call-stack');
?>
...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
      ...
      <div class="ms-auto">
        <div class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
            ...
            <a class="dropdown-item move-business" href="javascript:;" data-from="callStack" data-to="coldLeads">Move to Cold Leads</a>
            <a class="dropdown-item move-business" href="javascript:;" data-from="callStack" data-to="warmLeads">Move to Warm Leads</a>
            <a class="dropdown-item move-business" href="javascript:;" data-from="callStack" data-to="currentlyWorkingWith">Move to Currently Working With</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex align-items-center">
      <h6 class="mb-0 text-uppercase">Call Stack</h6>
      <div class="ms-auto">
        <a href="add-lead.php?category=callStack" class="btn btn-sm btn-primary">
    ...
    <div class="card">
      <div class="card-body">
        <div class="table-responsive">
          <table id="callStackTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
              <tr>
                <th>Niche</th>
                <th>Company Name</th>
...
$(document).ready(function() {
    var callStackTable = $('#callStackTable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": "fetch_leads.php",
            "type": "POST",
            "data": function(d) {
                d.category = "callStack"; // Explicitly set the category
                return d;
            }
        },
        "paging": true,
    ...
    $('#callStackTable tbody').on('click', 'tr', function(e) {
        ...
        var data = callStackTable.row(this).data();
        if (data) {
    ...
    if (savedLeadId) {
        ...
        callStackTable.on('draw', function() {
            // Find the row with this ID and select it
            const savedRow = $(`#callStackTable tbody tr[data-id="${savedLeadId}"]`);
